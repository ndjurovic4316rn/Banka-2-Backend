                                ...
                                <tr>
                                    <td style="padding:24px;text-align:center;">
                                        ...
                                        <p style="margin:0 0 16px 0;font-size:14px;color:#4b5563;">
                                            Your Banka 2 account has been activated successfully. You are all set.
                                        </p>
                                        <p style="margin:0 0 0 0;font-size:13px;color:#6b7280;">
                                            You can now log in with your email and password. If you run into any issues, please contact your administrator.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
